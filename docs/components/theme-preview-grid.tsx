...
const PREVIEWS: { title: string, name: string, wide?: boolean }[] = [
  ...
  { title: 'Badge', name: 'badge/variants' },
  { title: 'Kbd', name: 'kbd/group' },
  { title: 'Empty', name: 'empty/basic' },
  { title: 'Item', name: 'item/basic' },
  ...
  { title: 'Bubble', name: 'bubble/variants' },
  { title: 'Message', name: 'message/basic' },
  { title: 'Marker', name: 'marker/variants' },
  { title: 'Attachment', name: 'attachment/states' },
  { title: 'MessageScroller', name: 'message-scroller/basic', wide: true },
